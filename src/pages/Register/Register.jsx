          ...
          <div className="bg-white shadow-lg rounded-lg max-w-5xl w-full flex flex-col lg:flex-row items-center gap-6 p-6 sm:p-10">
            ...
            <div className="w-full lg:w-1/2 max-w-md">
              ...
              <form onSubmit={handleRegister} className="space-y-5">
                ...
                <button
                  type="submit"
                  className="w-full bg-cyan-700 text-white py-3 rounded-md font-semibold hover:bg-cyan-800 transition"
                >
                  Register
                </button>
              </form>
              ...
              <div className="text-center">
                <button
                  ...
                  className="flex items-center justify-center gap-3 w-full py-2 px-4 border border-cyan-700 text-cyan-700 rounded-md font-semibold hover:bg-cyan-700 hover:text-white transition"
                >
