...
const Navbar = () => {
    ...
    const navLinks = <>
        ...
        <li><NavLink to="/allArtCraftItems">All Plants</NavLink></li>
        {user && (
            <>
                <li><NavLink to="/addCraftItems">Add Plant</NavLink></li>
                <li><NavLink to="/myArtCraftList">My Plants</NavLink></li>
            </>
        )}
            ...
            <div className="navbar max-w-6xl mx-auto text-white">
                <div className="navbar-start">
                    ...
                    <Link to='/'>
                        <div className="w-20 h-18 flex items-center gap-4">
                            <img className="w-full h-full rounded-2xl object-cover" src="https://potropollob-58633.web.app/assets/logo-BEnKhIEz.png" alt="Logo" />
                ...
                <div className="navbar-end">
                    {user ? (
                        ...
                        <div className="flex">
                            <Link to="/login">
                                <button className="py-2 px-4 md:px-6 rounded font-semibold bg-white text-green-700">Login</button>
                            </Link>
                            <Link to="/register">
                                <button className="py-2 px-4 md:px-6 rounded font-semibold bg-white text-green-700 ml-2">Register</button>
                            </Link>
                        </div>
                    )}
                </div>
